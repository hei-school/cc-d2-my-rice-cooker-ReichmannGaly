...
func (rc *RiceCooker) TurnOn() error {
	...
	return fmt.Errorf("Rice cooker is not plugged in. Cannot turn on.")
}
...
func (rc *RiceCooker) CookRice() error {
	...
	return fmt.Errorf("Cannot cook rice. Rice cooker is off.")
}
...
func (rc *RiceCooker) KeepWarm() error {
	if rc.isCooking {
		return fmt.Errorf("Cannot activate Keep Warm while cooking.")
	} else if rc.isOn {
		rc.isKeepWarm = true
		fmt.Println("Keep Warm mode activated.")
		return nil
	}
	return fmt.Errorf("Rice cooker is off. Cannot activate Keep Warm.")
}
...
func (rc *RiceCooker) SteamCooking() error {
	...
	return fmt.Errorf("Rice cooker is off. Cannot activate Steam Cooking.")
}
